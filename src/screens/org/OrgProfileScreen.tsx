      ...
      <View style={styles.content}>
        <View style={styles.profileHead}>
          ...
          <View>
            ...
            <Text style={styles.role}>Organization Admin{me?.organization ? ` \u00B7 ${me.organization.name}` : ""}</Text>
          </View>
        </View>
        ...
        <View style={styles.noteCard}>
          <Text style={styles.noteText}>
            Employee, driver, vehicle, and route management currently live in the web Admin dashboard.
            This app covers live operations \u2014 Dashboard and Fleet.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  noteCard: { backgroundColor: colors.beige, borderRadius: radius.md, padding: spacing.md, marginBottom: spacing.lg },
  noteText: { fontSize: 11.5, color: colors.mauve, lineHeight: 17 },
