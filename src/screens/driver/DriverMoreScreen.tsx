      ...
      <View style={styles.content}>
        <View style={styles.profileHead}>
          ...
          <View>
            ...
            <Text style={styles.role}>Driver{me?.organization ? ` \u00B7 ${me.organization.name}` : ""}</Text>
          </View>
        </View>
        ...
        <View style={styles.card}>
          ...
          {trip?.vehicle_label && (
            <View style={styles.row}>
              <Text style={styles.rowLabel}>Assigned vehicle</Text>
              <Text style={styles.rowValue}>{trip.vehicle_label}</Text>
            </View>
          )}
        </View>
